...
function App() {
  ...
  const updateUserEvents = (newEvent) => {
    ...
    try {
      ...
      if (data.Response === "True") {
        ...
        updateUserEvents({
          ...
          timestamp: new Date().toISOString(),
          details: `Viewed details for: ${data.Title}`,
        });
      } else {
        console.error("API Error:", data.Error);
      }
  ...
  const toggleFavorite = (movie) => {
    ...
    if (isFavorite) {
      ...
      updateUserEvents({
        ...
        timestamp: new Date().toISOString(),
        details: `Removed from Favorites: ${movie.Title}`,
      });
    } else {
      ...
      updateUserEvents({
        ...
        timestamp: new Date().toISOString(),
        details: `Added to Favorites: ${movie.Title}`,
      });
    }
  };
  ...
  const handleRemoveFavorite = (movieId) => {
    ...
    updateUserEvents({
      eventType: "remove_favorite",
      timestamp: new Date().toISOString(),
      details: `Removed from Favorites: ${movieId}`,
    });
  };
